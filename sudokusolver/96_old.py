...
class Grid():
    ...
    def grid_number_to_multi_file_index(self):
        '''
    ...
    def load_grid_from_multi_file_and_transform(self):
        '''
        Loads a sudoku puzzle corresponding to the grid number from a multigrid
        file and transforms it into a triple nested array representation.
        '''
        file = open('sudoku_grids.txt', 'r')
        data = file.readlines()

        i, j = self.grid_number_to_multi_file_index()
        representation = ''
...
if (__name__ == '__main__'):
    ...
    for x in range(1, 51):
        ...
        current_puzzle.load_grid_from_multi_file_and_transform()
